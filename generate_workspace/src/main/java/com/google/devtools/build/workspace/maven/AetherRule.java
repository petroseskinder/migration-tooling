...
public class AetherRule implements Comparable<AetherRule> {

  private final DependencyNode node;
  private final Set<String> parents;
  private final Set<String> dependencies;

  public AetherRule(DependencyNode node) {
    this.node = node;
    this.parents = Sets.newHashSet();
    this.dependencies = Sets.newHashSet();
  }

  public void addParent(AetherRule parent) {
  ...
  public void addDependency(AetherRule dependency) {
  ...
  @Override
  public int compareTo(AetherRule o) {
